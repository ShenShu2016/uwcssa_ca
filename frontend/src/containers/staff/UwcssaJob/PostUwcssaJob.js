...
function PostUwcssaJob(props) {
  ...
  const handleSubmit = async () => {
    if(!uwcssaJobData.title || !uwcssaJobData.departmentName || !uwcssaJobData.requirements.filter(e=>e!=="")){
      setInfo(true)
      return
    }
    let allDepartments = await API.graphql(graphqlOperation(listDepartments));
    allDepartments.data.listDepartments.items.map(data=>departmentList.push(data.name))
    ...
    try {
      ...
      const newUwcssaJob = await API.graphql(graphqlOperation(createUwcssaJob,{input: createUwcssaJobInput}))
    ...
    <div className={classes.root}>
      ...
      <Box>
        ...
        <TextField
          ...
          onChange={(e) =>
            setUwcssaJobData({ ...uwcssaJobData, departmentName: e.target.value })
          }
        />
      </Box>
      <Box>
      ...
      <Table aria-label="simple table">
        <TableBody>
          {uwcssaJobData.requirements.map((row,index) => (
            <TableRow key={index}>
              <TableCell component="th" scope="row" width="1%">{index+1}</TableCell>
              <TableCell component="th" scope="row">
                ...
                onChange={(e) => {
                  ...
                  setUwcssaJobData({ ...uwcssaJobData, requirements: newRequirements })
                  console.log(uwcssaJobData)
                }}
                />
              </TableCell>
            ...
            <TableRow key={index}>
              ...
              <TableCell component="th" scope="row">
                ...
                onChange={(e) => {
                  ...
                  setUwcssaJobData({ ...uwcssaJobData, schedule: newSchedule })
                  console.log(uwcssaJobData)
                }}
                />
              </TableCell>
            ...
            <TableRow key={index}>
              ...
              <TableCell component="th" scope="row">
                ...
                onChange={(e) => {
                  ...
                  setUwcssaJobData({ ...uwcssaJobData, benefits: newBenefits })
                  console.log(uwcssaJobData)
                }}
                />
              </TableCell>
      ...
      <Snackbar open={info} anchorOrigin={{ vertical: 'top', horizontal: 'center' }} autoHideDuration={4000} onClose={handleCloseInfo}>
      ...
      <Snackbar open={depart} anchorOrigin={{ vertical: 'top', horizontal: 'center' }} autoHideDuration={4000} onClose={handleCloseDepart}>

...
export default function ForumPostSubComments ({ comment,isReplaying }) {
  ...
  return (
    <div className={classes.root}>
      ...
      {Object.keys(comment.forumPostSubComments.items).length === 0 ? (
        <div>...loading</div>
      ) : (
        <div>
          <Accordion expanded={!isReplaying} onChange={handleChange(!expanded)}>
            {/* <AccordionSummary
            ...
            >
              {expanded ? (
                <Button variant="text" endIcon={<ArrowDropUpRoundedIcon />}>
                  隱藏 {comment.forumPostSubComments.items.length} 回覆
                </Button>
              ) : (
                <Button variant="text" endIcon={<ArrowDropDownRoundedIcon />}>
                  查看 {comment.forumPostSubComments.items.length} 回覆
                </Button>
              )}
            </AccordionSummary> */}
            <AccordionDetails>

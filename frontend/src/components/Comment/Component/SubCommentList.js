...
import { selectSubCommentsByCommentID } from "../../../redux/slice/subCommentSlice";
...
export default function SubCommentList({ comment }) {
  ...
  //console.log(comment);
  const subComments = useSelector(selectSubCommentsByCommentID(comment.id));
